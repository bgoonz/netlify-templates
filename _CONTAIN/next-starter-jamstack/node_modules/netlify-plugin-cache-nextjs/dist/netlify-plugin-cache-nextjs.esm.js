...
module.exports = {
  ...
  onPreBuild: function onPreBuild(_ref) {
    return _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee() {
      var utils, inputs, paths, success, message;
      return runtime_1.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              utils = _ref.utils, inputs = _ref.inputs;
              paths = generateAbsolutePaths({
                inputs: inputs
              });
              _context.next = 4;
              return utils.cache.restore(paths.absolute.buildDir);
            ...
            case 4:
              ...
              if (success) {
                message = "Restored the cached " + paths.buildDirName + " folder at the location " + paths.absolute.buildDir;
                console.log(message);
                utils.status.show({
                  summary: "Restored the " + paths.buildDirName + " folder",
                  text: message
                });
              } else {
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              utils = _ref2.utils, inputs = _ref2.inputs;
              paths = generateAbsolutePaths({
                inputs: inputs
              });
              console.log(paths.absolute.buildDir + " " + (existsSync(paths.absolute.buildDir) ? 'exists' : 'does not exist') + " on disk");
              _context2.next = 5;
              return utils.cache.save(paths.absolute.buildDir, {
            ...
            case 5:
              ...
              if (success) {
                message = "Cached the " + paths.buildDirName + " folder at the location " + paths.absolute.buildDir;
                console.log(message);
                utils.status.show({
                  summary: "Saved the " + paths.buildDirName + " folder",
                  text: message
                });
              } else {
