    ...
    (function (e) {
      function fr(e, t, r) {
        ...
        (this.id = e),
          ...
          ar._.extend(this[n], t),
          this[n][b] === z && (this[n][b] = this[n][ut]),
          (this[st] = ar._.newDiv(this[n][Wn])),
          (this[st].id = e),
          (this[st]._layer = this),
          (this[c] = z),
          (this[Ut] = z),
          (this[$t] = z),
          (this[on] = pt),
          (s = ar._.newElement(this.id, this[st], _t, 1)),
          (s.onAttach = function () {
      ...
      return typeof e == Yt
        ...
        : ((e.fn[w] = function () {
          ...
          (e.fn[Xt] = function () {
            var t = e(this);
            t[Vn]("class").match(/(\s+|^)([0-9]+)u(\s+|$)/) &&
              t[wn](Bn, parseInt(RegExp.$2));
          }),
          (e.fn[v] = function (t) {
            var r, i, s;
            if (this[dt] > 1) {
            ...
            return (
              (i = e(this)),
              isNaN((s = parseInt(i[wn](Ft)))) && (s = 0),
              i[wn](q, i[k](zt))[k](zt, ar[n].baseZIndex + s + (t ? t : 1)),
              i
            );
          }),
          (e.fn[f] = function () {
            ...
            pushX: {
              show: function (e) {
                ...
                o[X](0)
                  ...
                  e[s](I),
                  window[i](function () {
                    o.add(u)[h]((t[Hn] == S ? An : "") + ar[ot](t[at]), 0),
                      window[i](function () {
                        e[s](Q);
                      }, ar[n][C]);
                  }, 50);
            ...
            pushY: {
              show: function (e) {
                ...
                o[X](0)
                  ...
                  e[s](I),
                  window[i](function () {
                    o.add(u)[h](0, (t[Hn] == T ? An : "") + ar[sn](t[R])),
                      window[i](function () {
                        e[s](Q);
                      }, ar[n][C]);
                  }, 50);
          ...
          (fr[N][Rt] = {
            "top-left": { v: rt, h: L, side: L },
            "top-right": { v: rt, h: S, side: S },
            top: { v: rt, h: E, side: rt },
            "top-center": { v: rt, h: E, side: rt },
            "bottom-left": { v: T, h: L, side: L },
            "bottom-right": { v: T, h: S, side: S },
            bottom: { v: T, h: E, side: T },
            "bottom-center": { v: T, h: E, side: T },
            left: { v: E, h: L, side: L },
            "center-left": { v: E, h: L, side: L },
            right: { v: E, h: S, side: S },
            "center-right": { v: E, h: S, side: S },
            center: { v: E, h: E, side: pt },
            "center-center": { v: E, h: E, side: pt },
          }),
          ...
          (fr[N][mn] = function () {
            ...
            (e = this),
              ...
              (o = ar._[Nt](t[kt])),
              (a = this[c]),
              a[k]("max-width", "")[k]("max-height", "")[k](D, "")[k](K, ""),
              (t[at] = ar._[Nt](t[D])),
              (t[R] = ar._[Nt](t[K])),
              t[at] == Z && (t[at] = a.outerWidth() + 1),
              t[R] == Z && (t[R] = a.outerHeight() + 1);
            if (t.maxWidth != mt || t[D] == Z)
              (t[at] = ar[ot](t[at])),
                (t._maxWidth = ar[ot](ar._[Nt](t.maxWidth))),
                (t[at] = Math.min(t[at], t._maxWidth));
            if (t.maxHeight != mt || t[K] == Z)
              (t[R] = ar[sn](t[R])),
                (t._maxHeight = ar[sn](ar._[Nt](t.maxHeight))),
                (t[R] = Math.min(t[R], t._maxHeight));
            a[k](D, t[at])[k](K, t[R]),
              ar._.vars[nt] == xn &&
                (t[R] == mt &&
                  !t[ut] &&
                  a[k](K, "-webkit-calc(" + t[R] + " + 70px)"),
                a.on(bt, "input,select,textarea", function (t, n) {
                  if (n) return;
                  window[i](function () {
                    ar[r][W][Pt](e[st]),
                      window[i](function () {
          ...
          (fr[N][Jt] = function () {
            ...
            (e = this[n]),
              ...
              t in this[Mt] || (t = an),
              this[Mt][t][Jt](this),
              e[b] && ar[r][m] === this && (ar[r][Un][dn](yt), (ar[r][m] = z)),
              this[s](Jt),
              (this[on] = pt);
          }),
          (fr[N].init = function () {
            var t = this[n],
              ...
              s = this;
            r[A](),
              r[Pn](Fn).each(function () {
                ar.parseInit(e(this));
              }),
              r[rn]("skel-layer")
                [wn](Ft, this.index)
                [k](zt, ar[n].baseZIndex)
                [k](u, On)
                [k]("-ms-overflow-style", "-ms-autohiding-scrollbar")
                [k]("-webkit-overflow-scrolling", "touch")
                [Jt]();
            ...
            if (!t[kt] || (typeof t[kt] !== Nn && !(t[kt] in this[Mt])))
              t[kt] = an;
            t.clickToHide &&
              r[Pn]("a")
                [k](wt, gn)
              ...
              r
                ...
                .on("touchmove", function (e) {
                  ...
                  (n = s[Ut] - e[Lt][qn][0].pageX),
                    (i = s[$t] - e[Lt][qn][0].pageY),
                    (o = r.outerHeight()),
                    (u = r.get(0).scrollHeight - r[X]());
          ...
          (ar = {
            ...
            create: function (t, i, s) {
              ...
              if (u in i) {
                ...
                return (
                  ar[n].wrap || ((ar[n].wrap = ht), ar.initWrappers()),
                  (a = new fr(t, i, ar.layerIndex++)),
                  (ar[r][F][t] = a),
                  o && (o[$]()[bn](a[st]), o.remove()),
                  s || ar._.updateState(),
                  a
                );
              }
            ...
            getBaseFontSize: function () {
              return ar._.vars.IEVersion < 9
                ? 16.5
                : parseFloat(getComputedStyle(ar[r][Un].get(0)).fontSize);
            },
            getHalf: function (e) {
              var t = parseInt(e);
              return typeof e == "string" && e.charAt(e[dt] - 1) == "%"
                ? Math.floor(t / 2) + "%"
                : Math.floor(t / 2) + _n;
            },
            lockView: function (e) {
              e == kn && ar[r][$n][k](P, ut),
                ar[n][Mn] != j &&
                  t.vars[nt] == xn &&
                  ar[r][ct][k](K, ar[r].document[K]()),
                ar[r][O].on(it, function (e) {
                  ...
                  (a = e(Xn + u[0])),
                    ...
                    n.each(function () {
                      var t = e(this),
                        n,
                        r;
                      (n = Math.max(0, t.parents("li")[dt] - 1)),
                        (r = t[Vn]("href")),
                        i.push(
                          '<a class="link depth-' +
                            n +
            ...
            unlockView: function (e) {
              e == kn && ar[r][$n][k](P, ""),
                ar[n][Mn] != j && t.vars[nt] == xn && ar[r][ct][k](K, ""),
                ar[r][O].off(it),
                ar[r][en].off(It),
                ar._.vars.isMobile || ar[r][en].off(jt);
            },
            init: function () {
              n in ar[n] && (ar._.extend(ar[n], ar[n][n]), delete ar[n][n]),
                ar._[Y](ar[n], function (e) {
                  ar[n][e] &&
                    typeof ar[n][e] == Nn &&
                    u in ar[n][e] &&
                    ((ar[n][F][e] = ar[n][e]), delete ar[n][e]);
                }),
                typeof ar[n][Mn] == "function" && (ar[n][Mn] = ar[n][Mn]()),
                ar[n][Mn] == j &&
                  (!ar._[Gt](j) || !ar._[Gt](U)) &&
                  (ar[n][Mn] = u),
                ar[n][Mn] == u && !ar._[Gt](U) && (ar[n][Mn] = Dt),
                ar._.vars[nt] == "wp" && (ar[n][Mn] = Dt),
                (ar[r][en] = e(window)),
                e(function () {
                  ar.initAnimation(),
                    ar.initObjects(),
                    ar[n].wrap && ar.initWrappers(),
                    ar.initLayers(),
                    ar.initIncludes(),
                    ar._.updateState();
                });
              ...
              if (ar[n][Mn] == j)
                ...
                ar[n][Mn] == Dt
                  ? (ar[r][en].resize(function () {
                    ...
                    ar[n][Tt].substr(0, 4) == "ease"
                      ? ((ar[n][Tt] = "swing"), (ar[n][C] = ar[n][C] * 0.65))
                      : (ar[n][Tt] = "linear"),
                    (e.fn[H] = function (t, r) {
                  ...
                  (e.fn[h] = function (n, i) {
                    ...
                    (n = parseInt(n)),
                      (i = parseInt(i)),
                      n != 0
                        ? ((t.vars[nt] == xn ? ar[r][ct] : ar[r][Un])[k](P, ut),
                          ar[r][O][k](D, ar[r][en][D]()))
                        : (l = function () {
                            (t.vars[nt] == xn ? ar[r][ct] : ar[r][Un])[k](
                              P,
                              ""
                            ),
                              ar[r][O][k](D, Z);
                    ...
                    for (o = 0; o < this[dt]; o++) {
                      ...
                      if (!s[h.id])
                        if ((d = fr[N][Rt][p[wn](At)])) {
                          ...
                          (d = p[u]()), (s[h.id] = { top: d[rt], left: d[L] });
                      (a = {}),
                        ar._[Y](s[h.id], function (e) {
                          var t;
                          switch (e) {
                            case rt:
                              t = ar[sn](s[h.id][e]) + i;
            ...
            initWrappers: function () {
              ar[n][Mn] != j
                ? (ar[r][Un].wrapInner('<div id="skel-layers-parent" />'),
                  (ar[r][ct] = e("#skel-layers-parent")),
                  ar[r][ct][k](u, fn)
                    [k](L, 0)
                    [k](rt, 0)
                    [k]("min-height", mt)
                    [k](D, mt))
                : (ar[r][ct] = ar[r][Un]),
                ar[r][ct].wrapInner('<div id="skel-layers-wrapper" />'),
                (ar[r][O] = e("#skel-layers-wrapper")),
                ar[r][O][k](u, zn)[k](L, 0)[k](S, 0)[k](rt, 0)[A](),
                (ar[r][W] = e('<div id="skel-layers-hiddenWrapper" />')[bn](
                  ar[r][ct]
                )),
                ar[r][W][k](K, mt),
                (ar[r][l] = e('<div id="skel-layers-visibleWrapper" />')[bn](
                  ar[r][ct]
                )),
                ar[r][l][k](u, zn),
                ar._[Bt](_t, ar[r][W][0]),
                ar._[Bt]("skel_layers_visibleWrapper", ar[r][l][0]),
                ar._[Bt]("skel_layers_wrapper", ar[r][O][0]),
                e("[autofocus]").focus(),
                ar.refresh();
            },
          }),
