...
(function (e) {
  ...
  (e.fn[u] = function () {
    return e(this)
      [C]("user-select", E)
      [C]("-khtml-user-select", E)
      [C]("-moz-user-select", E)
      [C]("-o-user-select", E)
      [C]("-webkit-user-select", E);
  }),
    (e.fn[v] = function (t) {
      var n;
      ...
      tt.on(i, function () {
        ...
        nt.each(function () {
          var i = e(this),
            d = i[y]();
          et.hideDelay > 0 &&
            i.add(d).on("mouseleave", function () {
              window[m](at),
              ...
              .on(x, function () {
                ...
                switch (et.mode) {
                  ...
                  case "slide":
                    (ot = b),
                      d[a](et[t]),
                      i.animate({ height: L }, et[w], et.easing, function () {
                        ot = l;
                      });
                    break;
                  case "fade":
                    (ot = b),
                      S && !et.noOpenerFade
                        ? (et[w] == "slow"
                            ...
                            ? (B = 40)
                            : (B = Math.floor(et[w] / 2)),
                          d.fadeTo(B, 0.01, function () {
                            d[a](et[t]),
                              d.fadeTo(et[w], 1),
                              i.fadeIn(et[w], function () {
                                ot = l;
                              });
                          }))
                        : (d[a](et[t]),
        ...
        tt[D]("li").each(function () {
          ...
          if (o[d] > 0) {
            et[V] &&
              (et.cloneOnDetach &&
                ((t = o.clone()), t.attr("class", "")[W]().appendTo(o[y]())),
              o[V]().appendTo(rt));
