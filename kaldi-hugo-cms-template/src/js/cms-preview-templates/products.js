      ...
      <div>
        ...
        <div className="bg-off-white pv4">
          <div className="ph3 mw7 center">
            <h2 className="f2 b lh-title mt0 mb2">
              {entry.getIn(["data", "intro", "heading"])}
            </h2>
            <p className="mt0 mb4 mw6">
        ...
        <div className="mw7 center">
          <div className="mw6 ph3 mb3">
            <h3 className="f3 b lh-title mt0 mb2">
        ...
        <div className="bg-off-white pv4 ph3">
          <div className="mw7 center">
            <h2 className="f2 b lh-title mt0 mb3">
              ...
              {(entry.getIn(["data", "pricing", "plans"]) || []).map(
                (plan, index) => (
                  <div className="w-33-ns ph2" key={index}>
                    <div className="ph2">
                      <h3 className="b f5 grey-3 tc lh-title mt0 mb3">
                        {plan.get("plan")}
                      </h3>
